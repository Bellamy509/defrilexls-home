      ...
      <header className={`sticky top-0 z-50 w-full bg-white transition-shadow duration-300 ${isScrolled ? 'shadow-md' : ''}`}>
        <div className="container mx-auto flex h-20 items-center justify-between px-4 lg:px-0">
          ...
          <nav className="hidden lg:flex items-center gap-x-6">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger className="flex items-center text-base font-normal text-foreground/90 hover:text-primary transition-colors outline-none">
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuItem asChild>
                  <a
                    href="https://app.defrilex-ls.com/buyer/login"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="cursor-pointer"
                  >
            ...
            <DropdownMenu>
              <DropdownMenuTrigger className="inline-flex items-center justify-center whitespace-nowrap rounded-[4px] text-base font-semibold h-10 px-6 bg-primary text-primary-foreground hover:bg-primary/90 transition-colors outline-none">
                Sign Up
                <ChevronDown className="ml-1 h-4 w-4" />
              </DropdownMenuTrigger>
              <DropdownMenuContent align="end" className="w-56">
          ...
          <div className="lg:hidden absolute w-full bg-white shadow-lg animate-accordion-down">
            <nav className="container mx-auto flex flex-col gap-y-1 p-4">
              ...
              <div className="space-y-2">
                <div className="text-sm font-medium text-foreground/70 px-3 py-1">Sign in</div>
                <a
                  href="https://app.defrilex-ls.com/freelancer/login"
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => setIsMenuOpen(false)}
                  className="block rounded-md py-2 px-6 text-base font-medium text-foreground hover:bg-accent hover:text-primary"
                >
                  Login as Interpreter
                </a>
                <a
              ...
              <div className="space-y-2 mt-4">
                <div className="text-sm font-medium text-foreground/70 px-3 py-1">Sign up</div>
                <a 
                  href="https://app.defrilex-ls.com/freelancer/register" 
                  target="_blank"
                  rel="noopener noreferrer"
